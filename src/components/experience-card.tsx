...
export default function ExperienceCard({
  ...
  return (
    <div className="w-full h-max mb-4 sm:mb-0 flex flex-col gap-y-4 sm:flex-row sm:p-2 lg:p-6 rounded-lg hover:bg-background-300 transition-all duration-300">
      ...
      <div className="flex flex-col grow px-2">
        ...
        <p
          className="text-secondary-text-500 text-base mt-4 leading-6"
