            ...
            <div className="w-1/2 flex flex-col gap-y-4">
                <div className="w-full flex items-center h-12 mb-8">
                    <div className="flex items-end">
                        <span className="text-blue-500 text-lg">01.</span>
                        <h3 className="ms-6 text-3xl text-primary-text-500 font-bold">About Me</h3>
                    </div>
                ...
                <div className="w-full flex">
                    <div className="grow shrink-0 max-w-[60%] flex flex-col pe-12">
                        <p className="text-secondary-text-500 text-justify">
                            Hello! I am Mario Nikolov. I enjoy solving problems and learning new things along the way.
                            My passion is designing systems and developing ready to use products that are scalable and easy to maintain.
                        </p>
                        <p className="text-secondary-text-500 mt-4 text-justify">
                            I always look for new challenges and opportunities to grow. My biggest goal is to become a person
                            that can be trusted and everyone can rely on.
                        </p>
                        <p className="text-secondary-text-500 mt-4 text-justify">
