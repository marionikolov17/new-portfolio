        ...
        <div className="w-full min-h-screen flex items-center justify-center">
            <div className="w-[750px] flex flex-col gap-y-4 overflow-x-hidden">
                <div className="py-2 flex">
                    <h2 className="text-5xl font-bold text-primary-text-500 capitalize">Let&apos;s get in touch.</h2>
                </div>
                <p className="text-secondary-text-500 text-base">Or you could send me an email on <span className="font-bold">marionikolovdev@gmail.com</span></p>
